...
import type { InputFileContent } from "../types/InputFileContent.js";
...
"file_url": z.optional(z.string().describe("The URL of the file to be sent to the model."))
    }).describe("A file input to the model.") as unknown as z.ZodType<InputFileContent>

export type InputFileContentSchema = InputFileContent