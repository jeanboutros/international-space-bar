...
"headers": z.optional(z.object({
    ...
    }).describe("An error payload that was emitted for a streaming error event.") as unknown as z.ZodType<ErrorPayload>

export type ErrorPayloadSchema = ErrorPayload