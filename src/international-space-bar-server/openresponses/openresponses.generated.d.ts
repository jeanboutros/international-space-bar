/**
 * @deprecated — migrate to z.infer<> from generated schemas in ./generated/zod/
 * See responses.types.ts for the migrated types.
 */
...
export interface paths {
    ...
    "/responses/compact": {
         ...
         */
        post: operations["compactResponse"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        WebSocketResponseCreateEvent: {
            ...
            background?: string;
        } & components["schemas"]["CreateResponseBody"];
        /**
        ...
        CompactResource: {
            ...
            created_at: number;
            usage: components["schemas"]["Usage"] & unknown;
        };
...
export interface operations {
    ...
    compactResponse: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["CompactResponseMethodPublicBody"];
            };
        };
        responses: {
            /** @description Success */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CompactResource"];
                };
            };
        };
    };
