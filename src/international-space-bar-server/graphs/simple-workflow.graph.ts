...
import { type GraphNode, StateGraph, START, END, StateSchema, MessagesValue } from "@langchain/langgraph";
import { stat } from "fs";
import { z } from "zod";
...
export const simpleWorkflowGraph = new StateGraph(WorkflowStateSchema, { context: ApplicationContextSchema })
